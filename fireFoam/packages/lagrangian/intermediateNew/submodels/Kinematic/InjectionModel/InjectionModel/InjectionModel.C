...
)
{
    ...
    parcelsAddedLocal_ += parcelsAdded;
...
:
    ...
    parcelsAddedLocal_
    (
        this->template getModelProperty<scalar>("parcelsAddedLocal")
    ),
...
:
    ...
    parcelsAddedLocal_(im.parcelsAddedLocal_),
...
void Foam::InjectionModel<CloudType>::info(Ostream& os)
{
    ...
    if (this->writeTime())
    {
        ...
        this->setModelProperty("parcelsAddedLocal", parcelsAddedLocal_);
