...
// luwi
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
//do nothing; to be defined only by derived class: CloudScatter
void
Foam::radiation::scatterModel::updatePhaseFuncs(const fvDOM& dom)
{}
//Flag to indicate cloud model is being used with PRECORRECTED
Foam::Switch
Foam::radiation::scatterModel::cloudCorrectedSigma() const
{
    return false;
}
